 ...
 * Spark k-means++
 */
public final class SparKMeansGroupByPlusPlus {
...
//        Broadcast<List<String>> init_center_broadcast;
        ...
        for (int experiment_i = 0; experiment_i < experiment_time; experiment_i++) {
            ...
            JavaRDD<String> data = spark.read().textFile(inputFile).javaRDD().cache();
