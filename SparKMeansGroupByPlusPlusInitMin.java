...
/**
 * Spark InitMin K-means
 */
public final class SparKMeansGroupByPlusPlusMinInit {
...
//            List<String> init_center = data.takeSample(false, 1);
            ...
            //get the min value(nearest to origin)
            ...
            //one method is max--as fas as possible,one method is min--origin
            //select nearest point from origin
            JavaPairRDD<Double, String> sort_data_abs_sum = data_abs_sum.sortByKey(true);
